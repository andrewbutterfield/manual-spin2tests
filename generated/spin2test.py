...
@_coconut_tco
def lines(string):
    return _coconut_tail_call(string.rsplit, '\n')
...
@_coconut_tco
def wordlines(string):
    return _coconut_tail_call(fmap, words, lines(string))
...
print("{} --({}`)-> [{};_;{}] >> {}\n".format(spinFile, refFile, preFile, postFile, testFile))
annote_lines = []
...
def refineSPINLines(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    ...
    if not _coconut_match_check:
        ...
        _coconut_match_err = _coconut_FunctionMatchError("pattern-matching failed for " "'def refineSPINLines([]):'" " in " + (_coconut_match_val_repr if _coconut.len(_coconut_match_val_repr) <= 500 else _coconut_match_val_repr[:500] + "..."))
        _coconut_match_err.pattern = 'def refineSPINLines([]):'
...
def refineSPINLines(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    ...
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) >= 1):
        lns = _coconut.list(_coconut_match_to_args[0][1:])
        ln = _coconut_match_to_args[0][0]
        if not _coconut_match_to_kwargs:
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_val_repr = _coconut.repr(_coconut_match_to_args)
        _coconut_match_err = _coconut_FunctionMatchError("pattern-matching failed for " "'match def refineSPINLines([ln]+lns):'" " in " + (_coconut_match_val_repr if _coconut.len(_coconut_match_val_repr) <= 500 else _coconut_match_val_repr[:500] + "..."))
        _coconut_match_err.pattern = 'match def refineSPINLines([ln]+lns):'
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
# INIT
@_coconut_mark_as_match
def refineSPINLine(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    _coconut_FunctionMatchError = _coconut_get_function_match_error()
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) == 1) and (_coconut_match_to_args[0][0] == 'INIT'):
        if not _coconut_match_to_kwargs:
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_val_repr = _coconut.repr(_coconut_match_to_args)
        _coconut_match_err = _coconut_FunctionMatchError("pattern-matching failed for " '"match def refineSPINLine([\'INIT\']):"' " in " + (_coconut_match_val_repr if _coconut.len(_coconut_match_val_repr) <= 500 else _coconut_match_val_repr[:500] + "..."))
        _coconut_match_err.pattern = "match def refineSPINLine(['INIT']):"
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
# NAME <name>
@_coconut_addpattern(refineSPINLine)
@_coconut_mark_as_match
def refineSPINLine(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    _coconut_FunctionMatchError = _coconut_get_function_match_error()
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) == 2) and (_coconut_match_to_args[0][0] == 'NAME'):
        name = _coconut_match_to_args[0][1]
        if not _coconut_match_to_kwargs:
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_val_repr = _coconut.repr(_coconut_match_to_args)
        _coconut_match_err = _coconut_FunctionMatchError("pattern-matching failed for " '"addpattern def refineSPINLine([\'NAME\',name]):"' " in " + (_coconut_match_val_repr if _coconut.len(_coconut_match_val_repr) <= 500 else _coconut_match_val_repr[:500] + "..."))
        _coconut_match_err.pattern = "addpattern def refineSPINLine(['NAME',name]):"
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
def refineSPINLine(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    _coconut_FunctionMatchError = _coconut_get_function_match_error()
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) == 3) and (_coconut_match_to_args[0][0] == 'DEF'):
        name = _coconut_match_to_args[0][1]
        value = _coconut_match_to_args[0][2]
        if not _coconut_match_to_kwargs:
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_val_repr = _coconut.repr(_coconut_match_to_args)
        _coconut_match_err = _coconut_FunctionMatchError("pattern-matching failed for " '"addpattern def refineSPINLine([\'DEF\',name,value]):"' " in " + (_coconut_match_val_repr if _coconut.len(_coconut_match_val_repr) <= 500 else _coconut_match_val_repr[:500] + "..."))
        _coconut_match_err.pattern = "addpattern def refineSPINLine(['DEF',name,value]):"
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
def refineSPINLine(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    _coconut_FunctionMatchError = _coconut_get_function_match_error()
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) == 3) and (_coconut_match_to_args[0][0] == 'DECL'):
        typ = _coconut_match_to_args[0][1]
        name = _coconut_match_to_args[0][2]
        if not _coconut_match_to_kwargs:
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_val_repr = _coconut.repr(_coconut_match_to_args)
        _coconut_match_err = _coconut_FunctionMatchError("pattern-matching failed for " '"addpattern def refineSPINLine([\'DECL\',typ,name]):"' " in " + (_coconut_match_val_repr if _coconut.len(_coconut_match_val_repr) <= 500 else _coconut_match_val_repr[:500] + "..."))
        _coconut_match_err.pattern = "addpattern def refineSPINLine(['DECL',typ,name]):"
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
def refineSPINLine(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    _coconut_FunctionMatchError = _coconut_get_function_match_error()
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) == 4) and (_coconut_match_to_args[0][0] == 'DECL'):
        typ = _coconut_match_to_args[0][1]
        name = _coconut_match_to_args[0][2]
        value = _coconut_match_to_args[0][3]
        if not _coconut_match_to_kwargs:
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_val_repr = _coconut.repr(_coconut_match_to_args)
        _coconut_match_err = _coconut_FunctionMatchError("pattern-matching failed for " '"addpattern def refineSPINLine([\'DECL\',typ,name,value]):"' " in " + (_coconut_match_val_repr if _coconut.len(_coconut_match_val_repr) <= 500 else _coconut_match_val_repr[:500] + "..."))
        _coconut_match_err.pattern = "addpattern def refineSPINLine(['DECL',typ,name,value]):"
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
def refineSPINLine(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    _coconut_FunctionMatchError = _coconut_get_function_match_error()
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) == 3) and (_coconut_match_to_args[0][0] == 'PTR'):
        name = _coconut_match_to_args[0][1]
        value = _coconut_match_to_args[0][2]
        if not _coconut_match_to_kwargs:
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_val_repr = _coconut.repr(_coconut_match_to_args)
        _coconut_match_err = _coconut_FunctionMatchError("pattern-matching failed for " '"addpattern def refineSPINLine([\'PTR\',name,value]):"' " in " + (_coconut_match_val_repr if _coconut.len(_coconut_match_val_repr) <= 500 else _coconut_match_val_repr[:500] + "..."))
        _coconut_match_err.pattern = "addpattern def refineSPINLine(['PTR',name,value]):"
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
def refineSPINLine(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    _coconut_FunctionMatchError = _coconut_get_function_match_error()
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) >= 2) and (_coconut_match_to_args[0][0] == 'CALL'):
        rest = _coconut.list(_coconut_match_to_args[0][2:])
        name = _coconut_match_to_args[0][1]
        if not _coconut_match_to_kwargs:
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_val_repr = _coconut.repr(_coconut_match_to_args)
        _coconut_match_err = _coconut_FunctionMatchError("pattern-matching failed for " '"addpattern def refineSPINLine([\'CALL\',name]+rest):"' " in " + (_coconut_match_val_repr if _coconut.len(_coconut_match_val_repr) <= 500 else _coconut_match_val_repr[:500] + "..."))
        _coconut_match_err.pattern = "addpattern def refineSPINLine(['CALL',name]+rest):"
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
    ...
    if name not in ref_dict.keys():
        ...
        code = ref_dict[name]
        _coconut_match_to = len(rest)
        _coconut_case_check_0 = False
        if _coconut_match_to == 0:
            _coconut_case_check_0 = True
        if _coconut_case_check_0:
            testCode = testCode + code.rsplit('\n')
        if not _coconut_case_check_0:
            if _coconut_match_to == 1:
                _coconut_case_check_0 = True
            if _coconut_case_check_0:
                testCode = testCode + (code.format(rest[0])).rsplit('\n')
        if not _coconut_case_check_0:
            if _coconut_match_to == 2:
                _coconut_case_check_0 = True
            if _coconut_case_check_0:
                testCode = testCode + (code.format(rest[0], rest[1])).rsplit('\n')
        if not _coconut_case_check_0:
            if _coconut_match_to == 3:
                _coconut_case_check_0 = True
            if _coconut_case_check_0:
                testCode = testCode + (code.format(rest[0], rest[1], rest[2])).rsplit('\n')
        if not _coconut_case_check_0:
            if _coconut_match_to == 4:
                _coconut_case_check_0 = True
            if _coconut_case_check_0:
                testCode = testCode + (code.format(rest[0], rest[1], rest[2], rest[3])).rsplit('\n')
        if not _coconut_case_check_0:
...
def refineSPINLine(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    _coconut_FunctionMatchError = _coconut_get_function_match_error()
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) == 2) and (_coconut_match_to_args[0][0] == 'STRUCT'):
        name = _coconut_match_to_args[0][1]
        if not _coconut_match_to_kwargs:
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_val_repr = _coconut.repr(_coconut_match_to_args)
        _coconut_match_err = _coconut_FunctionMatchError("pattern-matching failed for " '"addpattern def refineSPINLine([\'STRUCT\',name]):"' " in " + (_coconut_match_val_repr if _coconut.len(_coconut_match_val_repr) <= 500 else _coconut_match_val_repr[:500] + "..."))
        _coconut_match_err.pattern = "addpattern def refineSPINLine(['STRUCT',name]):"
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
def refineSPINLine(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    _coconut_FunctionMatchError = _coconut_get_function_match_error()
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) == 2) and (_coconut_match_to_args[0][0] == 'SEQ'):
        name = _coconut_match_to_args[0][1]
        if not _coconut_match_to_kwargs:
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_val_repr = _coconut.repr(_coconut_match_to_args)
        _coconut_match_err = _coconut_FunctionMatchError("pattern-matching failed for " '"addpattern def refineSPINLine([\'SEQ\',name]):"' " in " + (_coconut_match_val_repr if _coconut.len(_coconut_match_val_repr) <= 500 else _coconut_match_val_repr[:500] + "..."))
        _coconut_match_err.pattern = "addpattern def refineSPINLine(['SEQ',name]):"
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
def refineSPINLine(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    _coconut_FunctionMatchError = _coconut_get_function_match_error()
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) == 2) and (_coconut_match_to_args[0][0] == 'END'):
        name = _coconut_match_to_args[0][1]
        if not _coconut_match_to_kwargs:
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_val_repr = _coconut.repr(_coconut_match_to_args)
        _coconut_match_err = _coconut_FunctionMatchError("pattern-matching failed for " '"addpattern def refineSPINLine([\'END\',name]):"' " in " + (_coconut_match_val_repr if _coconut.len(_coconut_match_val_repr) <= 500 else _coconut_match_val_repr[:500] + "..."))
        _coconut_match_err.pattern = "addpattern def refineSPINLine(['END',name]):"
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
def refineSPINLine(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    _coconut_FunctionMatchError = _coconut_get_function_match_error()
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) == 3) and (_coconut_match_to_args[0][0] == 'SCALAR') and (_coconut_match_to_args[0][1] == '_'):
        value = _coconut_match_to_args[0][2]
        if not _coconut_match_to_kwargs:
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_val_repr = _coconut.repr(_coconut_match_to_args)
        _coconut_match_err = _coconut_FunctionMatchError("pattern-matching failed for " '"addpattern def refineSPINLine([\'SCALAR\',\'_\',value]):"' " in " + (_coconut_match_val_repr if _coconut.len(_coconut_match_val_repr) <= 500 else _coconut_match_val_repr[:500] + "..."))
        _coconut_match_err.pattern = "addpattern def refineSPINLine(['SCALAR','_',value]):"
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
def refineSPINLine(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    _coconut_FunctionMatchError = _coconut_get_function_match_error()
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) == 3) and (_coconut_match_to_args[0][0] == 'SCALAR'):
        field = _coconut_match_to_args[0][1]
        value = _coconut_match_to_args[0][2]
        if not _coconut_match_to_kwargs:
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_val_repr = _coconut.repr(_coconut_match_to_args)
        _coconut_match_err = _coconut_FunctionMatchError("pattern-matching failed for " '"addpattern def refineSPINLine([\'SCALAR\',field,value]):"' " in " + (_coconut_match_val_repr if _coconut.len(_coconut_match_val_repr) <= 500 else _coconut_match_val_repr[:500] + "..."))
        _coconut_match_err.pattern = "addpattern def refineSPINLine(['SCALAR',field,value]):"
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
def refineSPINLine(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    ...
    _coconut_FunctionMatchError = _coconut_get_function_match_error()
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) >= 1):
        rest = _coconut.list(_coconut_match_to_args[0][1:])
        hd = _coconut_match_to_args[0][0]
        if not _coconut_match_to_kwargs:
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_val_repr = _coconut.repr(_coconut_match_to_args)
        _coconut_match_err = _coconut_FunctionMatchError("pattern-matching failed for " "'match def refineSPINLine([hd]+rest):'" " in " + (_coconut_match_val_repr if _coconut.len(_coconut_match_val_repr) <= 500 else _coconut_match_val_repr[:500] + "..."))
        _coconut_match_err.pattern = 'match def refineSPINLine([hd]+rest):'
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
def refineSPINLine(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    ...
    if not _coconut_match_check:
        _coconut_match_val_repr = _coconut.repr(_coconut_match_to_args)
        _coconut_match_err = _coconut_FunctionMatchError("pattern-matching failed for " "'match def refineSPINLine([]):'" " in " + (_coconut_match_val_repr if _coconut.len(_coconut_match_val_repr) <= 500 else _coconut_match_val_repr[:500] + "..."))
        _coconut_match_err.pattern = 'match def refineSPINLine([]):'
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
with open(testFile, 'w') as tstfile:
    ...
    testWrapup = ['static void Init(rtems_task_argument arg)', '{', '   T_run_initialize(&config);', '   T_register();', '   T_run_by_name("{}");'.format(testName), '}']
